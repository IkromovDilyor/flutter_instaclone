...
import 'package:flutter_instaclone/services/http_services.dart';
class OtherProfilePage extends StatefulWidget {
  static final String id = 'someone_Profile_Page';

  String uid;
  OtherProfilePage({required this.uid}) : super();
...
class _OtherProfilePageState extends State<OtherProfilePage> {
  ...
  _showUserInfo(USer user) {
    setState(() {
      ...
      this.countFollowers = user.followers_count;
      this.countFollowing = user.following_count;
      isLoading = false;
    });
  }
  ...
  _apiFollowUser(USer someone) async {
    ...
    Map<String, dynamic> params = ServiceHttp.paramCreate(username, someone.device_token.toString());
    ServiceHttp.POST(params);
